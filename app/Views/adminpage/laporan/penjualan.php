...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Laporan Penjualan<br> <?= (isset($nama_wisata)) ? 'Wisata ' . $nama_wisata : '' ?></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card card-light">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="col-sm-12">
                                        <?php ($user['role'] === 'admin') ? $url = 'laporan/penjualan' : $url = 'laporan-penjualan-wisata/' . $id; ?>
                                ...
                                <div class="col-sm-6">
                                    <?php if (!empty($transaksi)) : ?>
                                        <?php ($user['role'] === 'admin') ? $url = 'laporan/penjualan/pdf' : $url = 'laporan-penjualan-pdf/' . $id; ?>
